								...
								?>											
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                <h4 id="<?php echo $_obj_data_main->get_id();?>" class="panel-title">
                                                <a class="accordion-toggle" data-toggle="collapse" href="#collapse_module_<?php echo $_obj_data_main->get_id();?>"><?php echo $_obj_data_main->get_desc_title();?> <span class="glyphicon glyphicon-menu-down pull-right"></span></a>
                                                </h4>
                                            </div>
                                            
                                            <div style="" id="collapse_module_<?php echo $_obj_data_main->get_id();?>" class="panel-collapse collapse">
                                                <div class="panel-body">
                                                    <?php echo $_obj_data_main->get_list_intro(); ?>
                                                    <?php												
                                                        if($_obj_data_main->get_hidden() == 0 || $_obj_data_main->get_hidden() == 1)
                                                        {
                                                        ?>
                                                            <p><a href="/classes/main.php?cClassID=<?php echo $_obj_data_main->get_id(); ?>" class="btn btn-success btn-lg"><span class="glyphicon glyphicon-play-circle"></span> Go!</a></p>
                                                        <?php
                                                        };
                                                    ?>                                                                 
                                                </div>                                                
